...
class CarRacing(gym.Env, EzPickle):
    ...
    def _create_track(self):
        ...
        for c in range(CHECKPOINTS):
            # changes from self.np_random.uniform
    ...
    def render(self, mode="human"):
        ...
        # add a McQueen image
        image_canvas = pygame.Surface((WINDOW_W, WINDOW_H), pygame.SRCALPHA)
        scaled_car_img = pygame.transform.scale(self.car.carImg, (6 * zoom, 3.1 * zoom))
        rotated_car_img = pygame.transform.rotate(scaled_car_img, 90)
        carImgRect = rotated_car_img.get_rect()
        image_canvas.blit(rotated_car_img, (WINDOW_W / 2 - carImgRect.center[0], 3 * WINDOW_H / 4 - carImgRect.center[1]))

        self.screen.blit(image_canvas, (0, 0))
